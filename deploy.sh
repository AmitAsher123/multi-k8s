...
docker build -t stephengrider/multi-server:latset -t stephengrider/multi-server:$SHA -f ./server/Dockerfile ./server
dpcker build -t stephengrider/multi-worke:latest -t stephengrider/multi-worker:$SHA -f ./worker/Dockerfile ./worker
